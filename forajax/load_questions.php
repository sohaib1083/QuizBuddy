...
?>
        ...
        <table>
            <tr>
                <td style="font-weight: bold; font-size: 20px; padding-bottom: 20px; padding-left:5px;" colspan="1">
        ...
        <table style="margin-left: 10px;">
            <tr>
                ...
                <td style="padding-left:10px; ">
                    ...
                    ?>
                        <img src="Teacher/<?php echo $opt1; ?>" height="100" width="100">
                    <?php
                    } else {
                        echo $opt1;
                    }
            ...
            <tr>
                ...
                <td style="padding-left:10px; ">
                    ...
                    ?>
                        <img src="Teacher/<?php echo $opt2; ?>" height="100" width="100">
                    <?php
                    } else {
                        echo $opt2;
                    }
            ...
            <tr>
                ...
                <td style="padding-left:10px; ">
                    ...
                    ?>
                        <img src="Teacher/<?php echo $opt3; ?>" height="100" width="100">
                    <?php
                    } else {
                        echo $opt3;
                    }
            ...
            <tr>
                ...
                <td style="padding-left:10px; ">
                    ...
                    ?>
                        <img src="Teacher/<?php echo $opt4; ?>" height="100" width="100">
                    <?php
                    } else {
                        echo $opt4;
                    }
